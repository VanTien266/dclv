  ...
  return (
    <div className={classes.root}>
      ...
      <Grid container className={classes.itemInfo} alignItems="flex-end">
        ...
        <Grid item>
          <Typography variant="body1">220.000.000 vnđ</Typography>
        </Grid>
      </Grid>
      <Grid container className={classes.itemInfo}>
        <Typography variant="body1">Thuế</Typography>
        <Typography variant="body1">22.000.000 vnđ</Typography>
      </Grid>
      <Grid container className={classes.itemInfo}>
        <Typography variant="body1">Đã đặt cọc</Typography>
        <Typography variant="body1">150.000.000 vnđ</Typography>
      </Grid>
      <Divider className={classes.divider} />
      <Grid container className={classes.itemInfo}>
        <Typography variant="h6">Thành tiền</Typography>
        <Typography variant="h6">72.000.000 vnđ</Typography>
      </Grid>
    </div>
  );
}
